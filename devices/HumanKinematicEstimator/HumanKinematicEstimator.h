...
#ifndef HDE_DEVICES_HUMANKINEMATICESTIMATOR
#define HDE_DEVICES_HUMANKINEMATICESTIMATOR
...
namespace hde {
    namespace devices {
        class HumanKinematicEstimator;
    } // namespace devices
} // namespace hde

class hde::devices::HumanKinematicEstimator final
...
public:
    HumanKinematicEstimator();
    ~HumanKinematicEstimator() override;
...
#endif // HDE_DEVICES_HUMANKINEMATICESTIMATOR
